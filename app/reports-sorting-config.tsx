...
const SORTING_CONFIG_KEY = '@reports_sorting_config';
...
export default function ReportsSortingConfigScreen() {
  ...
  const loadActiveSorting = async () => {
    const sortBy = await AsyncStorage.getItem('@sort_reports_by');
    if (sortBy) {
  ...
  const sortingOptions = [
    { key: 'date', label: t('sortByDate'), icon: 'event' },
    { key: 'machineType', label: t('sortByMachineType'), icon: 'category' },
  ];
