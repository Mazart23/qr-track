...
const resources = {
  en: {
    translation: {
      ...
      machinesConfig: 'Machines Configuration',
      sort: 'Sort',
      filter: 'Filter',
      sorting: 'Sorting',
      sortBy: 'Sort By',
      ...
      sortByName: 'Name',
      sortByStatus: 'Status',
      sortByType: 'Machine Type',
      sortBySerial: 'Serial Number',
      sortByLastReport: 'Last Report Date',
      ...
      clear: 'Clear',
      status_today: 'Report today',
      status_overdue: 'Overdue',
      "status_no-report": 'No reports',
      "status_no-qr": 'No QR',
      status_none: 'No status',
      daysUntilReport: 'Days until report',
      reportsCount: 'Number of reports',
      machinesFilters: 'Machines Filters',
      machinesSorting: 'Machines Sorting',
      sortOrder: 'Sort Order',
      ascending: 'Ascending',
      descending: 'Descending',
      found: 'Found',
      machines_zero: 'machines',
      machines_one: 'machine',
      machines_other: 'machines',
      reports_zero: 'reports',
      reports_one: 'report',
      reports_other: 'reports',
      reportsConfig: 'Reports Configuration',
      reportsFilters: 'Reports Filters',
      reportsSorting: 'Reports Sorting',
      sortByDate: 'Date',
      sortByMachineType: 'Machine Type',
      date: 'Date',
  ...
  pl: {
    translation: {
      ...
      machinesConfig: 'Konfiguracja maszyn',
      sort: 'Sortuj',
      filter: 'Filtruj',
      sorting: 'Sortowanie',
      ...
      sortByName: 'Nazwa',
      sortByStatus: 'Status',
      sortByType: 'Typ maszyny',
      sortBySerial: 'Numer seryjny',
      sortByLastReport: 'Data ostatniego raportu',
      ...
      clear: 'Wyczyść',
      status_today: 'Raport dzisiaj',
      status_overdue: 'Przeterminowane',
      "status_no-report": 'Brak raportów',
      "status_no-qr": 'Brak kodu QR',
      status_none: 'Brak statusu',
      daysUntilReport: 'Dni do raportu',
      reportsCount: 'Liczba raportów',
      machinesFilters: 'Filtry maszyn',
      machinesSorting: 'Sortowanie maszyn',
      sortOrder: 'Kolejność sortowania',
      ascending: 'Rosnąco',
      descending: 'Malejąco',
      found: 'Znaleziono',
      machines_zero: 'maszyn',
      machines_one: 'maszynę',
      machines_other: 'maszyn',
      reports_zero: 'raportów',
      reports_one: 'raport',
      reports_other: 'raportów',
      reportsConfig: 'Konfiguracja raportów',
      reportsFilters: 'Filtry raportów',
      reportsSorting: 'Sortowanie raportów',
      sortByDate: 'Data',
      sortByMachineType: 'Typ maszyny',
      date: 'Data',
      reportedToday: 'Raport dzisiaj',
    },
  },
};
